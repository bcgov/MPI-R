...
To find a project you can either

*  filter by variable or
*  type part of the project name in the Select Project box then choose.
...
selectizeGroupUI(
        ...
        inline = FALSE,
        params = list(
          var_one = list(inputId = "region", title = "Select Region", placeholder = 'select'),
          var_two = list(inputId = "municipality", title = "Select Municipality", placeholder = 'select'),
          var_three = list(inputId = "project_type", title = "Select Project Type", placeholder = 'select'),
          var_four = list(inputId = "project_category_name", title = "Select Project Category", placeholder = 'select'),
          var_five = list(inputId = "public_funding_ind", title = "Select Public Funding", placeholder = 'select'),
          var_six = list(inputId = "project_name", title = "Select Project", placeholder = 'select')
        )
      )
