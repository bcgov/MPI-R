...
renderTable({
  df <- res_mod()%>%
    distinct(project_id, project_name, region, municipality, project_type, project_category_name, public_funding_ind)%>%
    select(project_name, region, municipality, project_type, project_category_name, public_funding_ind, project_id)%>%
